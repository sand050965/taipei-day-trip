export default class UserAuthView {
  ...
  reset = () => {
    ...
    document.querySelector("#modalTitle").classList.remove("success");
    document.querySelector("#successMessage").classList.add("none");
    document.querySelector("#username").classList.remove("error-input");
    document.querySelector("#username").classList.add("correct-input");
    document.querySelector("#emailContainer").classList.remove("none");
    document.querySelector("#email").classList.remove("error-input");
    document.querySelector("#email").classList.add("correct-input");
    document.querySelector("#passwordContainer").classList.remove("none");
    document.querySelector("#password").classList.remove("error-input");
