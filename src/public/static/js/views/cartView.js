...
export default class CartView {
	renderInit = (result) => {
		...
		for (const data of result.data) {
			...
			const bookingTimeValidateResult = bookingTimeValidate(
				data.date,
				data.time
			);
			if (
				bookingDateValidateResult.result &&
				bookingTimeValidateResult.result
			) {
			...
			deleteImg.src =
				"https://d3e6ndnmeeirod.cloudfront.net/images/icon_delete.png";
